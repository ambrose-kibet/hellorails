...
**Hello rails** is an ongoing project which when finished will be a ruby on rails application which allows users to make posts, comments and leave likes, while saving all of this data to a database server.
...
- Twitter: [Twister](https://twitter.com/ambrose_kibet)
